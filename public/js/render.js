...
$.ajax({
    ...
    for(var i = 0; i < dbRestaurants.length; i++)
    {
        ...
        var elem = "<li>" + "<h3>" + dbRestaurants[i].name + "</h3>" 
    + "<p>" + dbRestaurants[i].address + " " + dbRestaurants[i].city + " " + dbRestaurants[i].state
    + " " + dbRestaurants[i].zip + "</p>";;
    $list.append(elem);
    
     var  butt = $('<button/>', { text: "visit", id: dbRestaurants[i].id, 
